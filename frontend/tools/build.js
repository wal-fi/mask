...
const css=baseCss+'dialog{width:min(42rem,calc(100% - 1.5rem));max-height:calc(100% - 1.5rem);overflow:auto;border:2px solid #164dc5;border-radius:.4rem;padding:1rem;color:#18212b;background:#fff}dialog::backdrop{background:#0008}dialog form{max-width:none}dialog button{margin:.25rem}select{font:inherit;padding:.6rem;min-height:2.75rem;max-width:100%}select:focus-visible{outline:3px solid #164dc5;outline-offset:3px}\n';
const resources=[
